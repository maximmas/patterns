...
Термины:
Модули - классы, компоненты, пакеты и т.д. 
Модули верхних уровней - используют другие модули, сами не содержат реализаций.
Модули нижних уровней - реализуют какой-то конкретный фуникционал.
