...
### Стратегия (Strategy)
Стартегия - это некий алгоритим, реализующий какое-либо действие. Шаблон позволяет использовать разные алгоритмы (стратегии) в зависимости 
от условий.
Пример: Есть клиентский код, выполняющий какие-то действия. В определенных местах необходимо логгировать данные. 
